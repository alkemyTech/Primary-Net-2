...
const DepositComponent = ({ account }) => {
  ...
  const handleDeposit = async () => {
    ...
    try {
      const { data } = await axios.post(
        "https://localhost:7149/api/FixedDeposit",
        {
          amount: amount,
  ...
  return (
    <>
      <Head>
        <title>Primates - Nex fixed term deposit</title>
      </Head>
      {showSuccess && (
        <SweetAlert
          title="Success!"
      ...
      <Head>
        <title>Primates - Make a fixed term</title>
      </Head>
      <Layout>
        <Box
          maxWidth="600px"
        ...
        >
          ...
          <Box display="flex" flexDirection="column" alignItems="center">
            ...
            <FormControl margin="normal" fullWidth>
              <InputLabel htmlFor="term" style={{ fontWeight: 600 }}>
                Term
              </InputLabel>
              <Select
                native
              ...
              >
                <option value="1-month" style={{ fontWeight: 600 }}>
                  1 month - return %5
                </option>
                <option value="3-months" style={{ fontWeight: 600 }}>
                  3 months - return %19
                </option>
                <option value="1-year" style={{ fontWeight: 600 }}>
                  1 year - return %85
                </option>
              </Select>
            </FormControl>
            ...
            <Box mt={6} sx={{ textAlign: "center" }}>
              ...
              <Typography
                variant="h5"
                sx={{ fontWeight: "bold", color: "#0077be" }}
              >
                ${account?.money}
              </Typography>
            </Box>
